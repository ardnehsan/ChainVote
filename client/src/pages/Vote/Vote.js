        ...
        <form onSubmit={this.handleFormSubmit}>
          <label>
            ...
            <select value={this.state.value} onChange={this.VoteSave}>
              <option value="Eatneat">Chain Vote</option>
              <option value="Chainvote">Chores</option>
              <option value="Chainvote">Eat Neat</option>
              <option value="Chainvote">Hello World</option>
              <option value="Chainvote">Snippets</option>
              <option value="Chainvote">Vibez</option>
            </select>
          </label>
